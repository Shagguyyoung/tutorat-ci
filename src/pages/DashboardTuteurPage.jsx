    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          ...
          <StatCard icon={Clock} valeur={`${heures.toFixed(1)}h`} label="Heures enseignées" color="bg-blue-50 text-blue-600" />
          <StatCard icon={Users} valeur={enAttente.length} label="En attente" color="bg-amber-50 text-amber-600" />
          <StatCard icon={TrendingUp} valeur={`${revenus.toLocaleString()} F`} label="Revenus totaux" color="bg-emerald-50 text-emerald-600" />
        </div>
