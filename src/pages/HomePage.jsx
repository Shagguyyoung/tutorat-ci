    ...
    <PageAnimee>
      <div className="min-h-screen bg-[#fafaf8]">
        ...
        <section className="py-14 px-6">
          <ListeAnimee className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
            {STATS.map(s => (
              <ItemAnimee key={s.label} className="text-center">
        ...
        <section className="py-16 px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <ListeAnimee className="grid md:grid-cols-3 gap-6">
              {TUTEURS.map(t => (
                <ItemAnimee key={t.id}>
                  <CarteAnimee>
                    <Link
                      to={`/tuteur/${t.id}`}
                      className="block bg-white rounded-3xl p-6 shadow-sm border border-gray-100"
                    >
        ...
        <section className="py-20 px-6 bg-white">
          ...
          <ListeAnimee className="max-w-4xl mx-auto grid md:grid-cols-3 gap-8 relative">
        ...
        <section className="py-20 px-6">
          <ListeAnimee className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6">
            <ItemAnimee>
              <div className="bg-gradient-to-br from-violet-600 to-violet-800 rounded-3xl p-10 text-center shadow-xl">
                ...
                <Link to="/recherche" className="mt-6 inline-block bg-white text-violet-700 font-bold px-8 py-3.5 rounded-2xl hover:bg-violet-50 transition-colors">
                  Trouver un tuteur →
                </Link>
              </div>
            </ItemAnimee>
            <ItemAnimee>
              <div className="bg-gradient-to-br from-amber-500 to-orange-600 rounded-3xl p-10 text-center shadow-xl">
                ...
                <Link to="/inscription" className="mt-6 inline-block bg-white text-orange-600 font-bold px-8 py-3.5 rounded-2xl hover:bg-orange-50 transition-colors">
                  Devenir tuteur →
                </Link>
              </div>
            </ItemAnimee>
