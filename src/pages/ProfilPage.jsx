...
import { FadeUp, FadeLeft, ListeAnimee, ItemAnimee, PageAnimee } from "../components/AnimationEntree"
            ...
            <FadeUp delay={0.3}>
              <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                ...
                {tuteur.reviews?.length === 0 || !tuteur.reviews ? (
                  ...
                  <ListeAnimee className="space-y-6">
                    {tuteur.reviews.map(a => (
                      <ItemAnimee key={a.id} className="border-b border-gray-50 pb-6 last:border-0 last:pb-0">
